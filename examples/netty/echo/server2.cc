...
private:
    ...
    void printThroughput()
    {
        ...
        printf("%.3f MiB/s %.2f Kilo Msgs/s %.2f bytes per msg, ", bytes / time / 1024 / 1024,
               static_cast<double>(msgs) / time / 1000, bytesPerMsg);
    ...
    void printConnection()
    {
        ...
        printf("%d conn, files %d , VmSize %ld KiB, RSS %ld KiB, ", connections_.get(), ProcessInfo::openedFiles(),
