...
public:
    ...
    {
        client_.setConnectionCallback(std::bind(&LogClient::onConnection, this, _1));
...
private:
    ...
    {
        // SHOULD NOT HAPPEN
        LogRecord *logRecord = xnet::down_cast<LogRecord *>(message.get());
...
int main(int argc, char *argv[])
{
    ...
    else
    {
        ...
        client.disconnect();
        CurrentThread::sleepUsec(1000 * 1000); // wait for disconnect, then safe to destruct LogClient (esp. TcpClient).
