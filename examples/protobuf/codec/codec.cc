...
void ProtobufCodec::fillEmptyBuffer(Buffer *buf, const google::protobuf::Message &message)
{
     ...
     * potential effect for previous xnet code/projects as far as possible.
...
void ProtobufCodec::defaultErrorCallback(const xnet::net::TcpConnectionPtr &conn, xnet::net::Buffer *buf,
                                         xnet::Timestamp, ErrorCode errorCode)
{
