...
#ifndef XNET_NET_PROTOBUF_PROTOBUFCODECLITE_H
#define XNET_NET_PROTOBUF_PROTOBUFCODECLITE_H
...
public:
    ...
    void fillEmptyBuffer(xnet::net::Buffer *buf, const google::protobuf::Message &message);
...
public:
    ...
    typedef std::function<void(const TcpConnectionPtr &, const ConcreteMessagePtr &, Timestamp)>
    ...
    {
        messageCallback_(conn, ::xnet::down_pointer_cast<MSG>(message), receiveTime);
    }

    void fillEmptyBuffer(xnet::net::Buffer *buf, const MSG &message) { codec_.fillEmptyBuffer(buf, message); }
...
#endif // XNET_NET_PROTOBUF_PROTOBUFCODECLITE_H
