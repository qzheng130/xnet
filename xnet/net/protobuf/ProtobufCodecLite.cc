...
// #include <xnet/net/protobuf/BufferStream.h>
...
void ProtobufCodecLite::fillEmptyBuffer(xnet::net::Buffer *buf, const google::protobuf::Message &message)
{
...
int ProtobufCodecLite::serializeToBuffer(const google::protobuf::Message &message, Buffer *buf)
{
     ...
     * 'ByteSize()' to avoid potential effect for previous xnet code/projects as far as possible. Note: All information
