...
void xnet::net::defaultConnectionCallback(const TcpConnectionPtr &conn)
{
...
void xnet::net::defaultMessageCallback(const TcpConnectionPtr &, Buffer *buf, Timestamp) { buf->retrieveAll(); }
