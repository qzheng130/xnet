...
{
    BOOST_CHECK_EQUAL(xnet::formatSI(0), string("0"));
    BOOST_CHECK_EQUAL(xnet::formatSI(999), string("999"));
    BOOST_CHECK_EQUAL(xnet::formatSI(1000), string("1.00k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(9990), string("9.99k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(9994), string("9.99k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(9995), string("10.0k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(10000), string("10.0k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(10049), string("10.0k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(10050), string("10.1k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(99900), string("99.9k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(99949), string("99.9k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(99950), string("100k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(100499), string("100k"));
    // FIXME:
    // BOOST_CHECK_EQUAL(xnet::formatSI(100500), string("101k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(100501), string("101k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(999499), string("999k"));
    BOOST_CHECK_EQUAL(xnet::formatSI(999500), string("1.00M"));
    BOOST_CHECK_EQUAL(xnet::formatSI(1004999), string("1.00M"));
    // BOOST_CHECK_EQUAL(xnet::formatSI(1005000), string("1.01M"));
    BOOST_CHECK_EQUAL(xnet::formatSI(1005001), string("1.01M"));
    BOOST_CHECK_EQUAL(xnet::formatSI(INT64_MAX), string("9.22E"));
}

BOOST_AUTO_TEST_CASE(testFormatIEC)
{
    BOOST_CHECK_EQUAL(xnet::formatIEC(0), string("0"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(1023), string("1023"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(1024), string("1.00Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(10234), string("9.99Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(10235), string("10.0Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(10240), string("10.0Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(10291), string("10.0Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(10292), string("10.1Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(102348), string("99.9Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(102349), string("100Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(102912), string("100Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(102913), string("101Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(1022976), string("999Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(1047552), string("1023Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(1047961), string("1023Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(1048063), string("1023Ki"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(1048064), string("1.00Mi"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(1048576), string("1.00Mi"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(10480517), string("9.99Mi"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(10480518), string("10.0Mi"));
    BOOST_CHECK_EQUAL(xnet::formatIEC(INT64_MAX), string("8.00Ei"));
}
